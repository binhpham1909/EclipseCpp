...
class TaskManager : public Singleton<TaskManager> {
	public:
		...
		virtual void addTask(String name, void (*func)(), bool (*conditionFunc)(), unsigned long time = 0);
		virtual void addTask(String name, void (*func)(), TMode mode, unsigned long time = 0);
		virtual void addTask(String name, void (*func)(), unsigned long time = 0);
		virtual void loop();
